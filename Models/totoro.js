...
function init() {
  ...
  const light = new THREE.DirectionalLight( 0xDFD6FF, 3 );
  light.position.set( 10, 10, 10 );
  light.castShadow = true;
  scene.add( light );

  // Add a directional light to the scene
  const light3 = new THREE.DirectionalLight( 0xDFD6FF, 3 );
  ...
  const light2 = new THREE.DirectionalLight( 0xDFD6FF, 3, 100 );
